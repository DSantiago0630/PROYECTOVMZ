            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="../cliente/editar_categoria.php?id=<?php echo $datos['idcate']; ?>"><button type="button" class="btn btn-danger"><i class="fi fi-bs-user-pen"></i></button></a></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form style="padding: 30px;" method="POST">
                        ...
                        <div class="mb-3">Categoría</label>
