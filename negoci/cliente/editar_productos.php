...
$sql = mysqli_query($conexion, "SELECT * FROM productos WHERE idpro = $idproduct");
    ...
    <div class="row">
        <div class="col-lg-6 m-auto">
            <form class="" action="" method="POST">
                ...
                <button type="submit" class="btn btn-info"><i class="fas fa-user-edit"></i> Actualizar Producto</button>
                </div>
             </form>
        </div>
    </div>
