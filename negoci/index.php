...
<body>
  <div class="container" style="background-color: blueviolet; margin-top:230px;">
    <div class="row" style="background-color: purple; text-align:center;">
      <div class="col" style="background-color:chocolate">
        <img src="cliente/img/logod.jpg" height="430px" width="430px">
      </div>
      <div class="col" style="background-color:darkblue;">
        ...
        <form style="padding: 30px;" method="POST">
          ...
          <div class="mb-3 form-check">
            ...
            <label class="form-check-label" for="exampleCheck1" style="color:white; text-align:center;">Check me out</label>
          </div>
          <a href="../inicio.php"><button type="submit" class="btn btn-warning">Iniciar Sesión</button>
        </form>
      </div>
    </div>
  </div>
